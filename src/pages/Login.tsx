      ...
      <main className="flex-1 flex items-center justify-center pt-20 pb-12 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground">Entrar no VooMilhas</h1>
          </div>
          <form onSubmit={handleLogin} className="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
            ...
            <p className="text-sm text-center text-muted-foreground">
              Não tem conta?{" "}
              <Link to="/cadastro" className="text-gold font-medium hover:underline">Cadastre-se</Link>
            </p>
          </form>
        </div>
      </main>
